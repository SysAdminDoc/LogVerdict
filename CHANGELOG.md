...
- **The curated database now contains 173 rules, up from 85.** New narrow rules cover 37 Windows failures observed on the development machine, all 30 documented Sysmon event types, 19 Defender detection, remediation, health, configuration and tamper events, and the two decoded crash-artifact sources. On the same 30-day live corpus this reduced unknown signatures from 43 of 76 (56.6%) to 6 of 76 (7.9%); the six left are product-specific providers and remain unknown rather than guessed.
